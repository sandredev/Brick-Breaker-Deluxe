...
public class PanelBotonSalir extends JPanel {
    Image imagenBotonActivo, imagenBotonInactivo;
    int ancho, alto;
    private ActionListener listener;
    private boolean estadoBoton = false;

    public PanelBotonSalir(int ancho, int alto) {
        this.ancho = ancho;
        this.alto = alto;
        ImageIcon imagen= new ImageIcon(getClass().getResource("/imagenes/botonSalirActivo.png"));
        imagenBotonActivo = imagen.getImage();
        imagen = new ImageIcon(getClass().getResource("/imagenes/botonSalirInactivo.png"));
        imagenBotonInactivo = imagen.getImage();
        setBounds(0, alto / 2 + 130, ancho, 70);
        setOpaque(false);
