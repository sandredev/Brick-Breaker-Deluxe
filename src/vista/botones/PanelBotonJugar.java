...
public class PanelBotonJugar extends JPanel {
    Image imagenBotonActivo, imagenBotonInactivo;
    int ancho, alto;
    private ActionListener listener;
    private boolean estadoBoton = true;

    public PanelBotonJugar(int ancho, int alto) {
        this.ancho = ancho;
        this.alto = alto;
        ImageIcon imagen = new ImageIcon(getClass().getResource("/imagenes/botonJugarActivo.png"));
        imagenBotonActivo = imagen.getImage();
        imagen = new ImageIcon(getClass().getResource("/imagenes/botonJugarInactivo.png"));
        imagenBotonInactivo = imagen.getImage();
        setBounds(0, alto/2+80, 410, 70);
        setOpaque(false);
